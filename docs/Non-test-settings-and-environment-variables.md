...
| PI_SERVER_CALL_DELAY_MILLIS | The number of milliseconds to wait before sending a message for replay when the PI Server returns an indication that indexing has not completed (defaults to 2000) |
