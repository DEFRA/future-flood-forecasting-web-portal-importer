...
| CONFIG_AUTHORIZATION | If resources specified through URL related app settings are protected, this app setting must be used to provide access. The value will be used to provide a token in a HTTP Authorization header. |
