...
* Microsoft Azure service bus queue named **fews-service-configuration-update-completed-queue**
  * Messages are placed on this queue when all configuration data has been refreshed within a configurable period of time defined by the [SERVICE_CONFIG_UPDATE_DETECTION_LIMIT app setting.](./Non-test-settings-and-environment-variables.md)
