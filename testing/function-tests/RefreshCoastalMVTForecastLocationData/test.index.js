...
module.exports = describe('Refresh coastal location data tests', () => {
  ...
  describe('The refresh coastal Multivariate Thresholds forecast location data function:', () => {
    ...
    it('should refresh given a valid csv with 0 exceptions', async () => {
      // Enable core engine message processing explicitly.
  ...
  async function mockFetchResponse (mockResponseData) {
    ...
    mockResponse = {
      ...
      body: fs.createReadStream(`testing/function-tests/RefreshCoastalMVTForecastLocationData/coastal_mvt_forecast_location_files/${mockResponseData.filename}`),
