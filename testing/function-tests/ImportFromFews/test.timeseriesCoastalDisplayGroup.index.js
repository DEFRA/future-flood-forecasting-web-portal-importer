module.exports = describe('Tests for import timeseries display groups', () => {
  ...
  describe('Message processing for coastal display group task run completion', () => {
    ...
    it('should import data for a single plot associated with an approved forecast task run', async () => {
      ...
      await importFromFewsTestUtils.processMessagesAndCheckImportedData('singlePlotApprovedForecast', [mockResponse])
    })
    it('should import data for multiple plots associated with an approved forecast task run', async () => {
      ...
      await importFromFewsTestUtils.processMessagesAndCheckImportedData('multiplePlotApprovedForecast', mockResponses)
    })
    ...
    it('should not import data for an approved out-of-date forecast task run', async () => {
      ...
      await importFromFewsTestUtils.processMessagesAndCheckImportedData('laterSinglePlotApprovedForecast', [mockResponse])
    ...
    it('should import data for a forecast manually approved task run', async () => {
      ...
      await importFromFewsTestUtils.processMessagesAndCheckImportedData('forecastApprovedManually', [mockResponse])
    })
    ...
    it('should load a single plot associated with a workflow that is also associated with non display group data', async () => {
      ...
      await importFromFewsTestUtils.processMessagesAndCheckImportedData('singlePlotAndFilterApprovedForecast', mockResponse, workflowAlreadyRan)
    })
