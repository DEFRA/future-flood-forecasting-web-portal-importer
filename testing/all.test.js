...
describe('Run all unit tests in sequence', () => {
  ...
  require('../ProcessFewsEventCode/test.forecastFlags.index')
  require('../ProcessFewsEventCode/test.timeseriesNonDisplayGroup.index')
  require('../ProcessFewsEventCode/test.timeseriesFluvialDisplayGroup.index')
  require('../ProcessFewsEventCode/test.timeseriesCoastalDisplayGroup.index')
  require('../ProcessFewsEventCode/test.timeseriesIgnoredWorkflow')
})
