  ...
  select
    case when
      exists (
         ...
         *
        from
          fff_staging.non_display_group_workflow n inner join
          fff_staging.coastal_display_group_workflow c on n.workflow_id = c.workflow_id
        where
      ...
      exists (
        ...
        from
          fff_staging.non_display_group_workflow n inner join
          fff_staging.fluvial_display_group_workflow f on n.workflow_id = f.workflow_id
        where
          n.workflow_id = @workflowId
      )
    then
