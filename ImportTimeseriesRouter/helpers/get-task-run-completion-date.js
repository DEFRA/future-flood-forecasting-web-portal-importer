...
module.exports = async function getTaskRunCompletionDate (context, preparedStatement, routeData) {
  ...
  return extract(context, routeData, taskRunCompletionDateRegex, 2, 1, taskRunCompletionDateText, preparedStatement)
}
