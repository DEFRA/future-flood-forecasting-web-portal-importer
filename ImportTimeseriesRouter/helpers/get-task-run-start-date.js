...
module.exports = async function getTaskRunStartDate (context, preparedStatement, message) {
  ...
  return extract(context, message, taskRunStartDateRegex, 2, 1, taskRunStartDateText, preparedStatement)
}
