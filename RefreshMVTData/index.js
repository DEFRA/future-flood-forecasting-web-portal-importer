...
module.exports = async function (context, message) {
  const refreshData = {
    ...
    functionSpecificData: [
      ...
      { tableColumnName: 'LOWER_BOUND', tableColumnType: 'Decimal', expectedCSVKey: 'lowerBound', precision: 5, scale: 2 },
      { tableColumnName: 'UPPER_BOUND', tableColumnType: 'Decimal', expectedCSVKey: 'upperBound', precision: 5, scale: 2 },
